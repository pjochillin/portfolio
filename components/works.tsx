...
export default function works() {
    ...
    return (
        <div id="works-div" className="mb-32 relative flex flex-col min-[750px]:flex-row justify-center space-x-16">
            ...
            <div className="basis-5/12 flex flex-row justify-center">
